...
<body>
  <div class="ui large top fixed menu transition visible" style="background-color: #c9c9c9; font-size: 15pt; display: flex !important;" ">
    <div class="ui container">
      ...
      <!--<div class="ui simple dropdown item" style="margin-right: 300px;">
        <div style="color:white;">Actions</div>
        <i class="dropdown icon"></i>
        <div class="menu">
          <a href="<?php echo base_url('mahasiswa/proposal'); ?>" class="item">Submit Proposal Tugas Akhir</a>
          <a href="<?php echo base_url('mahasiswa/edit'); ?>" class="item">Edit Proposal Tugas Akhir</a>
          <a href="<?php echo base_url('mahasiswa/info'); ?>" class="item">Informasi</a>
          <a href="<?php echo base_url('mahasiswa/list'); ?>" class="item">List Tugas Akhir</a>
      ...
      <!--<div class="ui simple dropdown item">
        ...
        <div class="menu">
          ...
          <a href="<?php echo base_url('mahasiswa/change'); ?>" class="item">Edit Seminar TA</a>
        </div>
      </div>-->
      <div class="right menu">
        <div class="ui simple dropdown item">
          ...
          <i class="dropdown icon"></i>
          <div class="menu">
            <a href="<?php echo base_url('user/logout'); ?>"class="item"><div style="color:black; border-radius: 20px;">Logout</div></a>
          </div>
        </div>
      </div>
    </div>
