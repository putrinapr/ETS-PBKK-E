...
<div style="background-color: #e2e2e2; width: 20%; height: 100%; float: left; position: fixed;">
   ...
   <a href=<?php echo base_url('verifikator/list'); ?>><h3 class="dashboard">List Proposal</h3></a>
</div>
<div class="ui middle aligned center aligned grid" style="margin-left: 300px;">
  ...
  <div class="row">
    <div class="ui cards">
      <div class="card" id="hovercard" style="border-radius: 20px;">
        <div class="content">
        ...
        <a href=<?php echo base_url('verifikator/list'); ?>>
