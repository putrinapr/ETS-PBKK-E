...
<div style="background-color: #e2e2e2; width: 20%; height: 100%; float: left; position: fixed;">
   ...
   <a href=<?php echo base_url('dosen/list'); ?>><h3 class="dashboard">Proposal</h3></a>
   <a href=<?php echo base_url('dosen/jadwal'); ?>><h3 class="dashboard">Seminar</h3></a>
</div>
  ...
  <div class="row">
    <div class="ui cards">
      ...
      <div id="hovercard" class="card" style="border-radius: 20px;">
        ...
        <a href=<?php echo base_url('dosen/list'); ?> >
